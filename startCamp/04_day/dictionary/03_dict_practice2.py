...
False
"""
# if 'requests' not in ssafy['language']['python']['python standard library']:
    # print("False")
...
print('requests' in ['os', 'random', 'webbrowser'])
...
pro-gj
"""
for gj in ssafy['classes']['gj'].values():
    print(gj)
...
오늘의 당번은 김준호
"""
dang = random.choice(ssafy['classes']['dj']['groups']['E'])
